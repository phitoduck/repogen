...
from ...models.actionscreate_or_update_org_secret_json_body import ActionscreateOrUpdateOrgSecretJsonBody
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ActionscreateOrUpdateOrgSecretJsonBody,
) -> Dict[str, Any]:
