...
from ...models.actionslist_workflow_runs_for_repo_status import ActionslistWorkflowRunsForRepoStatus
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/repos/{owner}/{repo}/actions/runs".format(client.base_url, owner=owner, repo=repo)
