...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/repos/{owner}/{repo}/actions/runs/{run_id}/attempts/{attempt_number}/logs".format(
...
def sync_detailed(
    ...
    *,
    ...
    link expires after
    1 minute. Look for `Location:` in the response header to find the URL for the download. Anyone with
    read access to
