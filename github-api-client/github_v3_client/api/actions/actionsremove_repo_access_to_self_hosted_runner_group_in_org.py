...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/orgs/{org}/actions/runner-groups/{runner_group_id}/repositories/{repository_id}".format(
        client.base_url, org=org, runner_group_id=runner_group_id, repository_id=repository_id
    )
...
def sync_detailed(
    ...
    *,
    ...
    \"[Create a self-hosted runner group for an organization](#create-a-self-hosted-runner-group-for-an-
    organization).\"
