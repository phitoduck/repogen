...
from ..models.dependabotcreate_or_update_org_secret_json_body_visibility import (
    DependabotcreateOrUpdateOrgSecretJsonBodyVisibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="DependabotcreateOrUpdateOrgSecretJsonBody")


@attr.s(auto_attribs=True)
class DependabotcreateOrUpdateOrgSecretJsonBody:
    """
    Attributes:
        visibility (DependabotcreateOrUpdateOrgSecretJsonBodyVisibility): Which type of organization repositories have
        ...
        encrypted_value (Union[Unset, str]): Value for your secret, encrypted with
            ...
            the [Get an organization public key](https://docs.github.com/rest/reference/dependabot#get-an-organization-
            public-key) endpoint.
        key_id (Union[Unset, str]): ID of the key you used to encrypt the secret.
        selected_repository_ids (Union[Unset, List[str]]): An array of repository ids that can access the organization
            ...
            secret](https://docs.github.com/rest/reference/dependabot#list-selected-repositories-for-an-organization-
            ...
            secret](https://docs.github.com/rest/reference/dependabot#remove-selected-repository-from-an-organization-
            secret) endpoints.
    """

    visibility: DependabotcreateOrUpdateOrgSecretJsonBodyVisibility
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        visibility = DependabotcreateOrUpdateOrgSecretJsonBodyVisibility(d.pop("visibility"))
        ...
        dependabotcreate_or_update_org_secret_json_body = cls(
            visibility=visibility,
        ...
        dependabotcreate_or_update_org_secret_json_body.additional_properties = d
        return dependabotcreate_or_update_org_secret_json_body
