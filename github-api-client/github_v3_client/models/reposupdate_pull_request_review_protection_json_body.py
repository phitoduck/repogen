...
from ..models.reposupdate_pull_request_review_protection_json_body_bypass_pull_request_allowances import (
    ReposupdatePullRequestReviewProtectionJsonBodyBypassPullRequestAllowances,
)
from ..models.reposupdate_pull_request_review_protection_json_body_dismissal_restrictions import (
    ReposupdatePullRequestReviewProtectionJsonBodyDismissalRestrictions,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReposupdatePullRequestReviewProtectionJsonBody")


@attr.s(auto_attribs=True)
class ReposupdatePullRequestReviewProtectionJsonBody:
    """
    Attributes:
        dismissal_restrictions (Union[Unset, ReposupdatePullRequestReviewProtectionJsonBodyDismissalRestrictions]):
        ...
        required_approving_review_count (Union[Unset, int]): Specifies the number of reviewers required to approve pull
            requests. Use a number between 1 and 6 or 0 to not require reviewers.
        bypass_pull_request_allowances (Union[Unset,
            ReposupdatePullRequestReviewProtectionJsonBodyBypassPullRequestAllowances]): Allow specific users, teams, or
            apps to bypass pull request requirements.
    """

    dismissal_restrictions: Union[Unset, ReposupdatePullRequestReviewProtectionJsonBodyDismissalRestrictions] = UNSET
    ...
    bypass_pull_request_allowances: Union[
        Unset, ReposupdatePullRequestReviewProtectionJsonBodyBypassPullRequestAllowances
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_dismissal_restrictions, Unset):
            ...
            dismissal_restrictions = ReposupdatePullRequestReviewProtectionJsonBodyDismissalRestrictions.from_dict(
        ...
        if isinstance(_bypass_pull_request_allowances, Unset):
            ...
            bypass_pull_request_allowances = (
                ReposupdatePullRequestReviewProtectionJsonBodyBypassPullRequestAllowances.from_dict(
                    _bypass_pull_request_allowances
                )
            )

        reposupdate_pull_request_review_protection_json_body = cls(
        ...
        reposupdate_pull_request_review_protection_json_body.additional_properties = d
        return reposupdate_pull_request_review_protection_json_body
