...
T = TypeVar("T", bound="PagesHealthCheckStatusAltDomain")
...
class PagesHealthCheckStatusAltDomain:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pages_health_check_status_alt_domain = cls(
            host=host,
            uri=uri,
        ...
        pages_health_check_status_alt_domain.additional_properties = d
        return pages_health_check_status_alt_domain
