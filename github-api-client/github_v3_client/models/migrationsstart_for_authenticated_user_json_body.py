...
from ..models.migrationsstart_for_authenticated_user_json_body_exclude_item import (
    MigrationsstartForAuthenticatedUserJsonBodyExcludeItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MigrationsstartForAuthenticatedUserJsonBody")


@attr.s(auto_attribs=True)
class MigrationsstartForAuthenticatedUserJsonBody:
    """
    Attributes:
        repositories (List[str]):
        lock_repositories (Union[Unset, bool]): Lock the repositories being migrated at the start of the migration
            Example: True.
        exclude_metadata (Union[Unset, bool]): Indicates whether metadata should be excluded and only git source should
            be included for the migration. Example: True.
        exclude_git_data (Union[Unset, bool]): Indicates whether the repository git data should be excluded from the
            migration. Example: True.
        exclude_attachments (Union[Unset, bool]): Do not include attachments in the migration Example: True.
        exclude_releases (Union[Unset, bool]): Do not include releases in the migration Example: True.
        exclude_owner_projects (Union[Unset, bool]): Indicates whether projects owned by the organization or users
            should be excluded. Example: True.
        ...
        exclude (Union[Unset, List[MigrationsstartForAuthenticatedUserJsonBodyExcludeItem]]): Exclude attributes from
            the API response to improve performance Example: ['repositories'].
    """
    ...
    exclude: Union[Unset, List[MigrationsstartForAuthenticatedUserJsonBodyExcludeItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for exclude_item_data in _exclude or []:
            exclude_item = MigrationsstartForAuthenticatedUserJsonBodyExcludeItem(exclude_item_data)

            exclude.append(exclude_item)

        migrationsstart_for_authenticated_user_json_body = cls(
            repositories=repositories,
        ...
        migrationsstart_for_authenticated_user_json_body.additional_properties = d
        return migrationsstart_for_authenticated_user_json_body
