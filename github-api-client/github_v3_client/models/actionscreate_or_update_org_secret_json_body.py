...
from ..models.actionscreate_or_update_org_secret_json_body_visibility import (
    ActionscreateOrUpdateOrgSecretJsonBodyVisibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ActionscreateOrUpdateOrgSecretJsonBody")


@attr.s(auto_attribs=True)
class ActionscreateOrUpdateOrgSecretJsonBody:
    """
    Attributes:
        visibility (ActionscreateOrUpdateOrgSecretJsonBodyVisibility): Which type of organization repositories have
        ...
        encrypted_value (Union[Unset, str]): Value for your secret, encrypted with
            ...
            the [Get an organization public key](https://docs.github.com/rest/reference/actions#get-an-organization-public-
            key) endpoint.
        ...
        selected_repository_ids (Union[Unset, List[int]]): An array of repository ids that can access the organization
            ...
            secret](https://docs.github.com/rest/reference/actions#list-selected-repositories-for-an-organization-secret),
            [Set selected repositories for an organization secret](https://docs.github.com/rest/reference/actions#set-
            selected-repositories-for-an-organization-secret), and [Remove selected repository from an organization
            secret](https://docs.github.com/rest/reference/actions#remove-selected-repository-from-an-organization-secret)
            endpoints.
    """

    visibility: ActionscreateOrUpdateOrgSecretJsonBodyVisibility
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        visibility = ActionscreateOrUpdateOrgSecretJsonBodyVisibility(d.pop("visibility"))
        ...
        actionscreate_or_update_org_secret_json_body = cls(
            visibility=visibility,
        ...
        actionscreate_or_update_org_secret_json_body.additional_properties = d
        return actionscreate_or_update_org_secret_json_body
