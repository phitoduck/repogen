...
T = TypeVar("T", bound="DependabotcreateOrUpdateRepoSecretJsonBody")


@attr.s(auto_attribs=True)
class DependabotcreateOrUpdateRepoSecretJsonBody:
    """
    Attributes:
        encrypted_value (Union[Unset, str]): Value for your secret, encrypted with
            ...
            the [Get a repository public key](https://docs.github.com/rest/reference/dependabot#get-a-repository-public-key)
            endpoint.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        dependabotcreate_or_update_repo_secret_json_body = cls(
            encrypted_value=encrypted_value,
            key_id=key_id,
        )

        dependabotcreate_or_update_repo_secret_json_body.additional_properties = d
        return dependabotcreate_or_update_repo_secret_json_body
