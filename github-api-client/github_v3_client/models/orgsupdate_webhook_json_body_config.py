...
T = TypeVar("T", bound="OrgsupdateWebhookJsonBodyConfig")


@attr.s(auto_attribs=True)
class OrgsupdateWebhookJsonBodyConfig:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        orgsupdate_webhook_json_body_config = cls(
            url=url,
        ...
        orgsupdate_webhook_json_body_config.additional_properties = d
        return orgsupdate_webhook_json_body_config
