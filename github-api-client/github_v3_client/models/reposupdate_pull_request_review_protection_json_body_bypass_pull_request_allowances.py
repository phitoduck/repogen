...
T = TypeVar("T", bound="ReposupdatePullRequestReviewProtectionJsonBodyBypassPullRequestAllowances")


@attr.s(auto_attribs=True)
class ReposupdatePullRequestReviewProtectionJsonBodyBypassPullRequestAllowances:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        reposupdate_pull_request_review_protection_json_body_bypass_pull_request_allowances = cls(
            users=users,
            teams=teams,
            apps=apps,
        )

        reposupdate_pull_request_review_protection_json_body_bypass_pull_request_allowances.additional_properties = d
        return reposupdate_pull_request_review_protection_json_body_bypass_pull_request_allowances
