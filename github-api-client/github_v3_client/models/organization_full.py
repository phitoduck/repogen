...
from ..models.organization_full_plan import OrganizationFullPlan
from ..types import UNSET, Unset

T = TypeVar("T", bound="OrganizationFull")
...
class OrganizationFull:
    ...
    Attributes:
        ...
        plan (Union[Unset, OrganizationFullPlan]):
        ...
        advanced_security_enabled_for_new_repositories (Union[Unset, bool]): Whether GitHub Advanced Security is enabled
            for new repositories and repositories transferred to this organization.

            This field is only visible to organization owners or members of a team with the security manager role.
        dependabot_alerts_enabled_for_new_repositories (Union[Unset, bool]): Whether GitHub Advanced Security is
            automatically enabled for new repositories and repositories transferred to
            this organization.

            This field is only visible to organization owners or members of a team with the security manager role.
        dependabot_security_updates_enabled_for_new_repositories (Union[Unset, bool]): Whether dependabot security
            updates are automatically enabled for new repositories and repositories transferred
        ...
        secret_scanning_push_protection_enabled_for_new_repositories (Union[Unset, bool]): Whether secret scanning push
            protection is automatically enabled for new repositories and repositories
    ...
    plan: Union[Unset, OrganizationFullPlan] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_plan, Unset):
            ...
            plan = OrganizationFullPlan.from_dict(_plan)
        ...
        organization_full.additional_properties = d
