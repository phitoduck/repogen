...
T = TypeVar("T", bound="ProjectsupdateResponse403")


@attr.s(auto_attribs=True)
class ProjectsupdateResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectsupdate_response_403 = cls(
            message=message,
            documentation_url=documentation_url,
            errors=errors,
        )

        projectsupdate_response_403.additional_properties = d
        return projectsupdate_response_403
