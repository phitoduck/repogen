...
T = TypeVar("T", bound="GistHistoryChangeStatus")
...
class GistHistoryChangeStatus:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        gist_history_change_status = cls(
            total=total,
            additions=additions,
            deletions=deletions,
        )

        gist_history_change_status.additional_properties = d
        return gist_history_change_status
