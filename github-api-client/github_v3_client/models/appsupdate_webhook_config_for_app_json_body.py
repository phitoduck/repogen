...
T = TypeVar("T", bound="AppsupdateWebhookConfigForAppJsonBody")


@attr.s(auto_attribs=True)
class AppsupdateWebhookConfigForAppJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        appsupdate_webhook_config_for_app_json_body = cls(
            url=url,
        ...
        appsupdate_webhook_config_for_app_json_body.additional_properties = d
        return appsupdate_webhook_config_for_app_json_body
