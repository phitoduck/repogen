...
T = TypeVar("T", bound="CodespacessetSelectedReposForOrgSecretJsonBody")


@attr.s(auto_attribs=True)
class CodespacessetSelectedReposForOrgSecretJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codespacesset_selected_repos_for_org_secret_json_body = cls(
            selected_repository_ids=selected_repository_ids,
        )

        codespacesset_selected_repos_for_org_secret_json_body.additional_properties = d
        return codespacesset_selected_repos_for_org_secret_json_body
