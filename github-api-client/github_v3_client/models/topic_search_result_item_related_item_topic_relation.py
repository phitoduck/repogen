...
T = TypeVar("T", bound="TopicSearchResultItemRelatedItemTopicRelation")
...
class TopicSearchResultItemRelatedItemTopicRelation:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        topic_search_result_item_related_item_topic_relation = cls(
            id=id,
            name=name,
            topic_id=topic_id,
        ...
        topic_search_result_item_related_item_topic_relation.additional_properties = d
        return topic_search_result_item_related_item_topic_relation
