...
T = TypeVar("T", bound="OrgsupdateWebhookConfigForOrgJsonBody")


@attr.s(auto_attribs=True)
class OrgsupdateWebhookConfigForOrgJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        orgsupdate_webhook_config_for_org_json_body = cls(
            url=url,
        ...
        orgsupdate_webhook_config_for_org_json_body.additional_properties = d
        return orgsupdate_webhook_config_for_org_json_body
