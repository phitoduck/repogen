...
T = TypeVar("T", bound="ProjectsdeleteCardResponse403")


@attr.s(auto_attribs=True)
class ProjectsdeleteCardResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectsdelete_card_response_403 = cls(
            message=message,
            documentation_url=documentation_url,
            errors=errors,
        )

        projectsdelete_card_response_403.additional_properties = d
        return projectsdelete_card_response_403
