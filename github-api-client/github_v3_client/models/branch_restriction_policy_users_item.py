...
T = TypeVar("T", bound="BranchRestrictionPolicyUsersItem")


@attr.s(auto_attribs=True)
class BranchRestrictionPolicyUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        branch_restriction_policy_users_item = cls(
            login=login,
            id=id,
            node_id=node_id,
        ...
        branch_restriction_policy_users_item.additional_properties = d
        return branch_restriction_policy_users_item
