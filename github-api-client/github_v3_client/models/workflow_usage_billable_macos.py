...
T = TypeVar("T", bound="WorkflowUsageBillableMACOS")
...
class WorkflowUsageBillableMACOS:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workflow_usage_billable_macos = cls(
            total_ms=total_ms,
        )

        workflow_usage_billable_macos.additional_properties = d
        return workflow_usage_billable_macos
