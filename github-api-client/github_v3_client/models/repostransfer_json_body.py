...
T = TypeVar("T", bound="RepostransferJsonBody")


@attr.s(auto_attribs=True)
class RepostransferJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        repostransfer_json_body = cls(
            new_owner=new_owner,
            team_ids=team_ids,
        )

        repostransfer_json_body.additional_properties = d
        return repostransfer_json_body
