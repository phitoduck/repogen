...
T = TypeVar("T", bound="ActionscreateOrUpdateRepoSecretJsonBody")


@attr.s(auto_attribs=True)
class ActionscreateOrUpdateRepoSecretJsonBody:
    """
    Attributes:
        encrypted_value (Union[Unset, str]): Value for your secret, encrypted with
            ...
            the [Get a repository public key](https://docs.github.com/rest/reference/actions#get-a-repository-public-key)
            endpoint.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        actionscreate_or_update_repo_secret_json_body = cls(
            encrypted_value=encrypted_value,
            key_id=key_id,
        )

        actionscreate_or_update_repo_secret_json_body.additional_properties = d
        return actionscreate_or_update_repo_secret_json_body
