...
T = TypeVar("T", bound="TeamscreateDiscussionLegacyJsonBody")


@attr.s(auto_attribs=True)
class TeamscreateDiscussionLegacyJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        teamscreate_discussion_legacy_json_body = cls(
            title=title,
            body=body,
            private=private,
        )

        teamscreate_discussion_legacy_json_body.additional_properties = d
        return teamscreate_discussion_legacy_json_body
