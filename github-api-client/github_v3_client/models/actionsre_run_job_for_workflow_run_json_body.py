...
T = TypeVar("T", bound="ActionsreRunJobForWorkflowRunJsonBody")


@attr.s(auto_attribs=True)
class ActionsreRunJobForWorkflowRunJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        actionsre_run_job_for_workflow_run_json_body = cls(
            enable_debug_logging=enable_debug_logging,
        )

        actionsre_run_job_for_workflow_run_json_body.additional_properties = d
        return actionsre_run_job_for_workflow_run_json_body
