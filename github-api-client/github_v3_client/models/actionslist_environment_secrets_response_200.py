...
T = TypeVar("T", bound="ActionslistEnvironmentSecretsResponse200")


@attr.s(auto_attribs=True)
class ActionslistEnvironmentSecretsResponse200:
    """
    Attributes:
        total_count (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        actionslist_environment_secrets_response_200 = cls(
            total_count=total_count,
            secrets=secrets,
        )

        actionslist_environment_secrets_response_200.additional_properties = d
        return actionslist_environment_secrets_response_200
