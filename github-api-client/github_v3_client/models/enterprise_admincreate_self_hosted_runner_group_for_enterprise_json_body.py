...
from ..models.enterprise_admincreate_self_hosted_runner_group_for_enterprise_json_body_visibility import (
    EnterpriseAdmincreateSelfHostedRunnerGroupForEnterpriseJsonBodyVisibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EnterpriseAdmincreateSelfHostedRunnerGroupForEnterpriseJsonBody")


@attr.s(auto_attribs=True)
class EnterpriseAdmincreateSelfHostedRunnerGroupForEnterpriseJsonBody:
    """
    Attributes:
        name (str): Name of the runner group.
        visibility (Union[Unset, EnterpriseAdmincreateSelfHostedRunnerGroupForEnterpriseJsonBodyVisibility]): Visibility
            of a runner group. You can select all organizations or select individual organization.
        selected_organization_ids (Union[Unset, List[int]]): List of organization IDs that can access the runner group.
    ...
    name: str
    visibility: Union[Unset, EnterpriseAdmincreateSelfHostedRunnerGroupForEnterpriseJsonBodyVisibility] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        selected_organization_ids: Union[Unset, List[int]] = UNSET
        if not isinstance(self.selected_organization_ids, Unset):
        ...
        if selected_organization_ids is not UNSET:
            field_dict["selected_organization_ids"] = selected_organization_ids
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        visibility: Union[Unset, EnterpriseAdmincreateSelfHostedRunnerGroupForEnterpriseJsonBodyVisibility]
        if isinstance(_visibility, Unset):
            visibility = UNSET
        else:
            visibility = EnterpriseAdmincreateSelfHostedRunnerGroupForEnterpriseJsonBodyVisibility(_visibility)

        selected_organization_ids = cast(List[int], d.pop("selected_organization_ids", UNSET))
        ...
        enterprise_admincreate_self_hosted_runner_group_for_enterprise_json_body = cls(
            name=name,
        ...
        enterprise_admincreate_self_hosted_runner_group_for_enterprise_json_body.additional_properties = d
        return enterprise_admincreate_self_hosted_runner_group_for_enterprise_json_body
