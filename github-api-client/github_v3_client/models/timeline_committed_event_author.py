...
T = TypeVar("T", bound="TimelineCommittedEventAuthor")
...
class TimelineCommittedEventAuthor:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeline_committed_event_author = cls(
            date=date,
            email=email,
            name=name,
        )

        timeline_committed_event_author.additional_properties = d
        return timeline_committed_event_author
