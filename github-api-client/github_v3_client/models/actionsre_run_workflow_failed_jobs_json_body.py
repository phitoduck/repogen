...
T = TypeVar("T", bound="ActionsreRunWorkflowFailedJobsJsonBody")


@attr.s(auto_attribs=True)
class ActionsreRunWorkflowFailedJobsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        actionsre_run_workflow_failed_jobs_json_body = cls(
            enable_debug_logging=enable_debug_logging,
        )

        actionsre_run_workflow_failed_jobs_json_body.additional_properties = d
        return actionsre_run_workflow_failed_jobs_json_body
