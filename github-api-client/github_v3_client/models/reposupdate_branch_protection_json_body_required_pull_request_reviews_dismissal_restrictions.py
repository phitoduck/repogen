...
T = TypeVar("T", bound="ReposupdateBranchProtectionJsonBodyRequiredPullRequestReviewsDismissalRestrictions")


@attr.s(auto_attribs=True)
class ReposupdateBranchProtectionJsonBodyRequiredPullRequestReviewsDismissalRestrictions:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        reposupdate_branch_protection_json_body_required_pull_request_reviews_dismissal_restrictions = cls(
            users=users,
            teams=teams,
            apps=apps,
        )

        reposupdate_branch_protection_json_body_required_pull_request_reviews_dismissal_restrictions.additional_properties = (
            d
        )
        return reposupdate_branch_protection_json_body_required_pull_request_reviews_dismissal_restrictions
