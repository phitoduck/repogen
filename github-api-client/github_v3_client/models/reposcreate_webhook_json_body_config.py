...
T = TypeVar("T", bound="ReposcreateWebhookJsonBodyConfig")


@attr.s(auto_attribs=True)
class ReposcreateWebhookJsonBodyConfig:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        reposcreate_webhook_json_body_config = cls(
            url=url,
        ...
        reposcreate_webhook_json_body_config.additional_properties = d
        return reposcreate_webhook_json_body_config
