...
from ..models.code_scanning_alert_rule_summary import CodeScanningAlertRuleSummary
...
T = TypeVar("T", bound="CodeScanningAlertItems")
...
class CodeScanningAlertItems:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rule = CodeScanningAlertRuleSummary.from_dict(d.pop("rule"))
        ...
        code_scanning_alert_items.additional_properties = d
        return code_scanning_alert_items
