...
T = TypeVar("T", bound="CodespacescreateWithRepoForAuthenticatedUserJsonBody")


@attr.s(auto_attribs=True)
class CodespacescreateWithRepoForAuthenticatedUserJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codespacescreate_with_repo_for_authenticated_user_json_body = cls(
            ref=ref,
            location=location,
            client_ip=client_ip,
            machine=machine,
        ...
        codespacescreate_with_repo_for_authenticated_user_json_body.additional_properties = d
        return codespacescreate_with_repo_for_authenticated_user_json_body
